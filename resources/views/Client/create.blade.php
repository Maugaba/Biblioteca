            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex flex-column">
                        <!--begin::Title-->
                        <h2 class="text-white font-weight-bold my-2 mr-5">Crear Cliente</h2>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <div class="d-flex align-items-center font-weight-bold my-2">
                            ...
                            <!--begin::Item-->
                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                            <a href="{{url('/client/create')}}" class="text-white text-hover-white opacity-75 hover-opacity-100">Crear Cliente</a>
                            <!--end::Item-->
                        </div>
                        <!--end::Breadcrumb-->
                    </div>
                                ...
                                <div class="wizard-steps p-8 p-lg-10">
                                    ...
                                    <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                        <div class="wizard-label">
                                            ...
                                            <h3 class="wizard-title">1. Crea Cliente</h3>
                                        </div>
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    error: function(error){
                        swal.fire({
                            title: 'Error',
                            text: 'Error al agregar un cliente',
                            icon: 'error',
                            confirmButtonText: 'Aceptar'
                        });
                    }
