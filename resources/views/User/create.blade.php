            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex flex-column">
                        <!--begin::Title-->
                        <h2 class="text-white font-weight-bold my-2 mr-5">Crear Usuario</h2>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <div class="d-flex align-items-center font-weight-bold my-2">
                            ...
                            <!--begin::Item-->
                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                            <a href="{{url('/user/crear')}}" class="text-white text-hover-white opacity-75 hover-opacity-100">Crear Usuario</a>
                            <!--end::Item-->
                        </div>
                        <!--end::Breadcrumb-->
                    </div>
                                ...
                                <div class="wizard-steps p-8 p-lg-10">
                                    ...
                                    <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                        <div class="wizard-label">
                                            ...
                                            <h3 class="wizard-title">1. Crea Usuario</h3>
                                        </div>
                                ...
                                <div class="col-xl-12 col-xxl-7">
                                    ...
                                    <form class="form" id="kt_form">
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                            <h3 class="mb-10 font-weight-bold text-dark">Crea un Usuario</h3>
                                            <!--begin::Input-->
                                            <div class="form-group">
                                                <label>Nombre de usuario</label>
                                                <input type="text" class="form-control form-control-solid form-control-lg" name="username" id="username" placeholder="Ingresar nombre del Usuario" />
                                                <span class="form-text text-muted">Ingrese el usuario.</span>
                                            </div>
                                            <!--end::Input-->
                                            <!--begin::Input-->
                                            <div class="form-group">
                                                <label>Contraseña</label>
                                                <input type="password" class="form-control form-control-solid form-control-lg" name="password" id="password" placeholder="*****"  />
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content">
                                            ...
                                            <h6 class="font-weight-bolder mb-3">Nombre usuario:</h6>
...
function StoreData() {
    ...
    if (username == '' || password == '' || booksQuantity == '') {
        swal.fire({
            title: 'Error',
...
function ShowData() {
    ...
    var booktextn = document.getElementById('usuario');
    var booktexte = document.getElementById('contraseña');

    booktextn.innerHTML = username;
    booktexte.innerHTML = password;
}
