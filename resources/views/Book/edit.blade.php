            ...
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex flex-column">
                        <!--begin::Title-->
                        <h2 class="text-white font-weight-bold my-2 mr-5">Editar Libro</h2>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <div class="d-flex align-items-center font-weight-bold my-2">
                            ...
                            <!--begin::Item-->
                            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                            <a href="{{url('/book/create')}}" class="text-white text-hover-white opacity-75 hover-opacity-100">Editar Libro</a>
                            <!--end::Item-->
                        </div>
                        <!--end::Breadcrumb-->
                    </div>
                                ...
                                <div class="wizard-steps p-8 p-lg-10">
                                    ...
                                    <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                        <div class="wizard-label">
                                            ...
                                            <h3 class="wizard-title">1. Editar Libro</h3>
                                        </div>
                                ...
                                <div class="col-xl-12 col-xxl-7">
                                    ...
                                    <form class="form" id="kt_form">
                                        ...
                                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                            <h3 class="mb-10 font-weight-bold text-dark">Edita un Libro</h3>
                                            <!--begin::Input-->
                                            <div class="form-group">
                                                <label>Nombre del Libro</label>
                                                <input type="text" class="form-control form-control-solid form-control-lg" name="booksName" id="booksName" value="{{ $Book->nombreDelLibro }}" placeholder="Ingresar nombre del libro" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-solid form-control-lg" name="booksEditor" id="booksEditor" value="{{ $Book->autoresOEditorial }}" placeholder="Ingrese el autor o editorial"  />
                                                <span class="form-text text-muted">Por favor ingrese el autor o editorial.</span>
                                            </div>
                                            <div class="form-group">
                                                <label>Cantidad</label>
                                                <input type="text" class="form-control form-control-solid form-control-lg" name="booksQuantity" id="booksQuantity" value="{{ $Book->cantidad }}" placeholder="Ingrese la cantidad de libros"  />
                                        ...
                                        <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                            ...
                                            <div>
                                                <button type="button" class="btn btn-success font-weight-bolder text-uppercase px-9 py-4" onclick="UpdateData()" >Editar</button>
